...
class Emojifier {
    ...
    private static final float SMILING_THRESHOLD = 0.15f;
    ...
    private static void whichEmoji(Face face) {
        ...
        boolean leftEyeOpen = face.getIsLeftEyeOpenProbability() > EYE_OPEN_THRESHOLD;
        boolean rightEyeOpen = face.getIsRightEyeOpenProbability() > EYE_OPEN_THRESHOLD;
        Emoji emoji;
        if (smiling) {
